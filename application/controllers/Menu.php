...
class Menu extends CI_Controller {  
    ...
    public function index()
    {
        ...
        $data['user'] = $this->db->get_where('user', ['email' => $this->session->userdata('email')])->row_array();//karna sebaris menggunakan row_array();

        $data['menu'] = $this->db->get('user_menu')->result_array();            //karna banyak menggunakan result_array()
    ...
    public function editSubmenu()
    {
        ...
        $data['submenu'] = $this->db->get('user_sub_menu')->result_array();            //karna banyak menggunakan result_array()
